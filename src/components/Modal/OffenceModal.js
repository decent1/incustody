...
//         async function get(){
//             setIsLoading(true)
//             const respones = await request.GetRequestWithAuthentication(api.offencesAPI())
...
//                     <Text style={styles.title}>{'Select Offence'}</Text>
//                     <TouchableOpacity 
...
export default function StationModal({ 
    ...
    async function getData(current_page){
        setIsLoading(true)
        const response = await request.GetRequestWithAuthentication(api.offencesAPI(current_page,per_page))
