...
export default function CityModal_Station({ 
    modalVisible,
    onSelect,
    country_id,
    state_id
    ...
    async function getData(current_page){
        setIsLoading(true)
        const response = await request.GetRequestWithAuthentication(api.CityAPI(current_page,per_page, country_id,state_id))
