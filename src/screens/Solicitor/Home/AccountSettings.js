        ...
        <TouchableOpacity onPress={openControlPanel} style={{}}>
          ...
          <ScrollView>
            ...
            <View style={{marginHorizontal: 16}}>
              <Text style={styles.des}>{'Solicitor/ Preferences '}</Text>
              ...
              {show === 4 ? (
                <View>
                  <View style={styles.availabilitySetting}>
                    <View style={styles.availability}>
                      <Text style={styles.availability_title}>
                        Availability{' '}
                      </Text>
                    </View>
                    <Text style={styles.availability_des}>
                      Turn on or off your availability to work
                    </Text>
                  </View>
                  <View style={styles.accountSettings}>
                    <View style={{padding: 15}}>
                    ...
                    <View style={{padding: 15}}>
                      ...
                      <View style={styles.matter}>
                        <Text style={styles.matter_txt}>New Matter</Text>
                        <View style={styles.checkContainer}>
                        ...
                        <View style={styles.checkContainer}>
                          ...
                          <Text style={styles.checkTxt}>Acton</Text>
                        </View>
                        <View style={styles.checkContainer}>
                          <View style={styles.checkBox}>
                            <AntDesign
                          ...
                          <Text style={styles.checkTxt}>Albany Street</Text>
                        </View>
                        <View style={styles.checkContainer}>
                          <View style={styles.checkBox}>
                            <AntDesign
                          ...
                          <Text style={styles.checkTxt}>Aylesbury</Text>
                        </View>
                        <View style={styles.checkContainer}>
                          <View style={styles.checkBox}>
                            <AntDesign
                          ...
                          <Text style={styles.checkTxt}>Barking</Text>
                        </View>
                        <View style={styles.checkContainer}>
                          <View style={styles.checkBox}>
                            <AntDesign
                          ...
                          <Text style={styles.checkTxt}>Barkingside</Text>
                        </View>
                        <View style={styles.checkContainer}>
                          <View style={styles.checkBox}>
                            <AntDesign
                          ...
                          <Text style={styles.checkTxt}>Barnet</Text>
                        </View>
                      </View>
                    </View>
                  </View>
