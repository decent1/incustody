...
import Header from '../../../components/Header/Header';
  ...
  const JoiningRequest2 = ({navigation}) => {
          ...
          <ScrollView>
            ...
            <View style={styles.mainView}>
              ...
              <View style={styles.MatterBox}>
                ...
                <View style={styles.inputContainer}>
                  <Text style={[styles.inputTitle]}>{'Assign to '}</Text>
                  <Input
                    placeholder="Confirm details below"
                    style={styles.input}
                  />
                </View>
                <Text style={styles.subHeading}>New Firm Details</Text>
                <View style={styles.inputContainer}>
                  <Text style={[styles.inputTitle]}>{'Firm’s Name'}</Text>
                  <Input
                    value={firmName}
                ...
                <View style={styles.inputContainer}>
                  ...
                  <Input
                    ...
                    placeholder="Ernest plaza 123"
                    style={styles.input}
                  />
                </View>
                <View style={styles.inputContainer}>
                  <Text style={[styles.inputTitle]}>{'DX'}</Text>
                  <Input
                    value={dx}
                    onChangeText={text => setDx(text)}
                ...
                <View
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => {
                      navigation.navigate('JoiningRequest3');
                    }}>
                    <LinearGradient
                      colors={[Colors.primary, '#3b5998', '#192f6a']}
                  ...
                  <TouchableOpacity
                    onPress={() => navigation.navigate('JoiningRequest3')}
                    activeOpacity={0.8}
                    style={[
  ...
  export default JoiningRequest2;
