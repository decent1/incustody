import {
  ...
  const UpdateAgent = ({navigation, route}) => {
          ...
          <View style={commonStyles.container}>
            <ScrollView>
              ...
              <View style={styles.mainView}>
                <Text style={styles.des}>{'Admin/ Update Agent'}</Text>
                <Text style={styles.title}>{'Update Agent'}</Text>
              </View>
