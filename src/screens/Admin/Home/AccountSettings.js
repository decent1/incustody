...
import AddTempleteModal from '../../../components/Modal/AddTempleteModal';
...
const AccountSetting = ({navigation}) => {
  ...
  const [modalVisible_Template, setModalVisible_Template] = useState(false);
  ...
  const [detail_button, setDetail_button] = useState([
    ...
    { id:4, name:'Message Templates', },
    // { id:5, name:'App Settings' }
  ])

  useEffect(() => {
    getTempletes()
  },[])
  async function getTempletes(){
  ...
  const [template, setTemplate] = useState([
    {
      id: 1,
      title: 'Agent -  Attendance Accepted',
  ...
  return (
    <Drawer ref={_drawer}
      ...
      tweenHandler={ratio => ({ main: {opacity: (2 - ratio) / 2}, })}>
        ...
        <Modal
          visible={modalVisible_Template}
          transparent={true}
          animationType="fade"
          onRequestClose={() => { setModalVisible_Template(false); }}>
          <AddTempleteModal
            modalVisible={() => setModalVisible_Template(false)}
            onSuccess={() => {
              setModalVisible_Template(false)
              getTempletes()
            }}
          />
        </Modal>
      ...
      <TouchableOpacity onPress={openControlPanel} style={{}}>
        ...
        <ScrollView>
          ...
          <View style={{marginHorizontal: 16}}>
            <Text style={styles.des}>{'Admin/ Preferences '}</Text>
                  ...
                  <View style={styles.accountSettings}>
                    <View style={{padding: 15}}>
                      <View style={styles.availability}>
                        <Text style={styles.MessageTemplate_title}>
                          Message Templates
                        </Text>
                      </View>
                      <Text style={styles.MessageTemplate_des}>
                        All available templates to be sent at.
                      </Text>
                      <TouchableOpacity 
                      onPress={() => {
                        setModalVisible_Template(true)
                      }}
                      ...
                      {template.map((value, index) => {
                        return (
                          <View key={index} style={styles.templateContainer}>
                            <Text style={styles.template_title}>Title</Text>
                            <Text style={styles.template_txt}>
                              {value.title}
                            </Text>
                            <Text style={styles.template_title}>
                              Subject Line
                            </Text>
                            <Text style={styles.template_txt}>
                              {value.subject}
                            </Text>
                            <Text style={styles.template_title}>Type</Text>
                            <Text style={styles.template_txt}>
                              {value.type}
                            </Text>
                            <Text style={styles.template_title}>Content</Text>
                            <Text style={styles.template_txt}>
                              {value.content != null ? value.content : 'N/A'}
                            </Text>
                          </View>
                        );
                      })}
                      ...
                      {appSetting.map((value, index) => {
                        return (
                          <View key={index} style={styles.templateContainer}>
                            ...
                            <Text style={styles.template_title}>Action</Text>
                            <TouchableOpacity
                              onPress={() =>
                                setModalVisible_OverNightAttendence(true)
                              }>
                              <Text
                                style={[
                                  styles.template_txt,
